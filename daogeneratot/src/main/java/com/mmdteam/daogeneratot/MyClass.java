package com.mmdteam.daogeneratot;
...
public class MyClass {
    ...
    public static void main(String[] args) {
        Schema rootSchema = new Schema(1, "com.mmdteam.mgithub.dao");
        ...
        try {
            new DaoGenerator().generateAll(rootSchema, "/Users/weiyi/workspace/android/MGitHub/app/src/main/java");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void addAuthUser(Schema schema) {
        ...
        entity.addIntProperty("id").notNull();
